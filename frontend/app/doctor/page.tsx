              ...
              {loadingList ? (
                ...
                patients.map((patient, idx) => (
                  <motion.div
                    ...
                    className="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  >
                    {/* Urgency Badge */}
                    ...
                    {/* Join Button */}
                    <button
                      onClick={() => handleJoinRoom(patient)}
                      disabled={joining}
